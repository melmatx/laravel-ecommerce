        ...
        <section>
            <div class="container mx-auto py-9 md:py-12 px-4 md:px-6">
                <div class="flex items-strech justify-center flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 lg:space-x-8">
                    <div class="flex flex-col md:flex-row items-strech justify-between bg-gray-50 py-6 px-6 md:py-12 lg:px-12 md:w-8/12 lg:w-7/12 xl:w-8/12 2xl:w-9/12 hover:opacity-30 cursor-pointer">
                        <div class="flex flex-col justify-center md:w-1/2">
                            <h1 class="text-3xl lg:text-4xl font-semibold text-gray-800">Best Deal</h1>
                            <p class="text-base lg:text-xl text-gray-800 mt-2">Save upto <span class="font-bold">50%</span></p>
                        </div>
                    ...
                    <div class="md:w-4/12 lg:w-5/12 xl:w-4/12 2xl:w-3/12 bg-gray-50 py-6 px-6 md:py-0 md:px-4 lg:px-6 flex flex-col justify-center relative hover:opacity-30 cursor-pointer">
                        <div class="flex flex-col justify-center">
                            <h1 class="text-3xl lg:text-4xl font-semibold text-gray-800">Game Console</h1>
                            <p class="text-base lg:text-xl text-gray-800">Save Upto <span class="font-bold">30%</span></p>
                        </div>
