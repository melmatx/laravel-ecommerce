    ...
    <div class="container mx-auto py-6 md:py-10 px-4 md:px-6">
        <div
            ...
            <div
                ...
                <a href="{{ route("product.show", $product) }}" class="inline-flex justify-between">
                    <div class="flex flex-col justify-center md:w-2/3">
                        <h1 class="text-3xl lg:text-4xl font-semibold text-gray-800">{{ $product->name }}</h1>
                        <p class="text-base lg:text-xl text-gray-800 mt-2"> {{ $product->description }}</p>
                    </div>
            ...
            <div
                ...
                <a href="{{ route("category.show", $category) }}" class="inline-flex justify-between">
                    <div class="flex flex-col justify-center gap-y-3">
                        <h1 class="text-3xl lg:text-4xl font-semibold text-gray-800">{{ $category->name }}</h1>
                        <p class="text-base lg:text-xl text-gray-800">Save Upto <span class="font-bold">30%</span>
                        </p>
                    </div>
                    <div class="flex justify-end md:absolute md:bottom-4 md:right-4 lg:bottom-0 lg:right-0">
                        <img src="{{ $category->products->random()->image_url }}" alt=""
