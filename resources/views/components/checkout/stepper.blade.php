...
<div>
    ...
    <div>
        <div class="overflow-hidden rounded-full bg-gray-200">
            <div class="h-2 {{ $progress }} rounded-full bg-blue-500"></div>
        </div>
        ...
        <ol class="mt-4 grid grid-cols-3 text-sm font-medium text-gray-500">
            ...
            <li class="flex items-center justify-center @if($step >= 2) text-blue-600 @endif sm:gap-1.5">
            ...
            <li class="flex items-center justify-end @if($step >= 3) text-blue-600 @endif sm:gap-1.5">
